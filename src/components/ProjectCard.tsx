...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div className="md:w-[500px] md:h-[900px] min-w-[350px] shadow-md rounded-lg border border-[#98beb5] bg-white/90 text-darkBlue3 font-semibold transform duration-200 hover:scale-103">
