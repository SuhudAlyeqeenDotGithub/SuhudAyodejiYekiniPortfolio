...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div className="w-[450px] min-w-[300px] shadow-md rounded-lg border border-[#98beb5] bg-white/90 text-darkBlue3 font-semibold transform duration-200 hover:scale-103">
